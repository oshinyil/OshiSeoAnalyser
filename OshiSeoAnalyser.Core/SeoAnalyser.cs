...
{
    public class SeoAnalyser
    {
        private static readonly char[] Separators = { '.', '?', '!', ' ', ';', ':', ',' };
        private static readonly string[] StopWords = { "a", "about", "above", "after", "again", "against", "all", "am", "an", "and", "any",
        ...
        public static IDictionary<string, int> Analyse(string rawText)
        {
            ...
            var cleanWords = GetCleanWordList(rawText);
        ...
        private static IEnumerable<string> GetCleanWordList(string rawText)
        {
            ...
            return splittedWords.Where(x => !StopWords.Contains(x));
        }

        private static IDictionary<string, int> CountWordOccurences(IEnumerable<string> words)
        {
